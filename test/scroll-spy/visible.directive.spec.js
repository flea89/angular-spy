import visible from '../../src/js/spies/visible.directive';
...
describe('visible', () => {
    let rootScope,
        ...
        template = `
            <div spy-fake-scroller>
                <p spy-visible="visible"></p>
            </div>
        `;
    ...
    beforeEach(angular.mock.inject(($compile, $rootScope, $timeout, $window) => {
        ...
        parentElement.data('$spyScrollContainerController', scrollContainerController);
        rootScope = $rootScope;
        scope = $rootScope.$new();
